...
class CandidatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create candidate" do
    assert_difference('Candidate.count') do
      post candidates_url, params: { candidate: { email: @candidate.email, name: @candidate.name, phone_number: @candidate.phone_number } }
    end
  ...
  test "should update candidate" do
    patch candidate_url(@candidate), params: { candidate: { email: @candidate.email, name: @candidate.name, phone_number: @candidate.phone_number } }
